                ...
                <div class="col-md-3">
                    <div class="surfaces-section bg-white rounded">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-center align-items-center card" data-name="North Wall" data-width="600" data-height="300">
                            ...
                            <li class="list-group-item d-flex justify-content-center align-items-center card" data-name="North Wall" data-width="500" data-height="200">
                                <span class="surface-name">North Wall</span>
                                <div class="dropdown position-absolute top-0 end-0">
                                    <button class="btn btn-link" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fas fa-ellipsis-v ms-auto"></i>
                            ...
                            <li class="list-group-item d-flex justify-content-center align-items-center card" data-name="North Wall" data-width="700" data-height="300">
                                <span class="surface-name">North Wall</span>
                                <div class="dropdown position-absolute top-0 end-0">
                                    <button class="btn btn-link" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fas fa-ellipsis-v ms-auto"></i>
