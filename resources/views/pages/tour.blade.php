...
<x-menu>
    ...
    <x-menu-item route="#" target="_self" text="Map" icon="fal fa-map-marked-alt" data-bs-toggle="modal"
...
<script>
    ...
    function assign_object_properties(obj, name, properties) {
        ...
        if (properties.depth === undefined) properties.depth = 40;
