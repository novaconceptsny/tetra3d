...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="float-end">
                <a href="{{ route('surfaces.create') }}" class="btn btn-sm btn-outline-primary"><i
                    ...
                    @forelse($surfaces as $surface)
                        <tr>
                            ...
                            <td>
                                <x-backend::dropdown.container permission="update|delete" :permission_params="$surface">
                                    <x-backend::dropdown.item
                                        ...
                                        :route="route('surfaces.edit', $surface)">
                            ...
                            <x-backend::modals.confirm
                                ...
                                :route="route('surfaces.destroy', $surface)"
